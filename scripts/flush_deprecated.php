...
system('export PAKITISQL=pakiti-`date +%d.%m.%y`.sql; cd ' . $dest_dir . '/pakiti-backup-egi; mysqldump --compact -h ' . $dbhost . ' -u ' . $user . ' -p"' . $password . '" ' . $dbname . ' > $PAKITISQL; bzip2 $PAKITISQL');
